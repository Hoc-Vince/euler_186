...
if __name__ == "__main__":
    ...
    while exit_trigger!=True:
        ...
        if friends_db != []:
            ...
            for i in range(len(friends_db)):
                ...
                if called_list_index !=None and caller_list_index !=None:
                    ...
                    print(f'WARNING !!! END broad search. Values NOT found. caller_id value: {friends_db[caller_list_index]} called_id value: {friends_db[called_list_index]}')
        ...
        for i in range(friends_db):
            if number in friends_db[i]:
                pm_index=i
                break
        prime_minister_friends_share=(1+len(friends_db[pm_index])
